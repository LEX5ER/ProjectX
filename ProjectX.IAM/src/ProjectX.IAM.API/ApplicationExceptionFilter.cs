...
public sealed class ApplicationExceptionFilter : IExceptionFilter
{
    public void OnException(ExceptionContext context)
    {
        ...
        context.Result = exception switch
        {
            ...
            ApplicationUnauthorizedException unauthorizedException => new ObjectResult(new ProblemDetails
            {
                Title = unauthorizedException.Title,
                Detail = unauthorizedException.Detail,
